...
if [ -f DeepLabV3-Plus-MobileNet_512x288.pre.post.tflite ]; then
    ...
    vnnx_compile -s V1000 -c ncomp -t DeepLabV3-Plus-MobileNet_512x288.pre.post.tflite  -o DeepLabV3-Plus-MobileNet_512x288_V1000_ncomp.vnnx
fi
...
if [ -f DeepLabV3-Plus-MobileNet_512x288_V1000_ncomp.vnnx ]; then
    echo "Running Simulation..."
    python $VBX_SDK/example/python/segmentation.py DeepLabV3-Plus-MobileNet_512x288_V1000_ncomp.vnnx $VBX_SDK/tutorials/test_images/A0PQ76.jpg --dataset VOC --inj 
    echo "C Simulation Command:"
    echo '$VBX_SDK/example/sim-c/sim-run-model DeepLabV3-Plus-MobileNet_512x288_V1000_ncomp.vnnx $VBX_SDK/tutorials/test_images/A0PQ76.jpg  '
fi
