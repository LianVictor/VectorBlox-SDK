...
echo "Checking for yolov8s_comp68 files..."

# model details @ https://github.com/ultralytics/ultralytics/
[ -f coco.names ] || wget -q https://raw.githubusercontent.com/pjreddie/darknet/master/data/coco.names
if [ ! -f yolov8s_comp68.tflite ]; then
   wget -q https://github.com/Microchip-Vectorblox/assets/releases/download/assets/yolov8s_comp68.onnx
fi
...
if [ -f yolov8s_comp68.onnx ]; then
   if ! echo "85ff1cd90943f35e75cf455df23fcc50 yolov8s_comp68.onnx" | md5sum -c; then
       echo -e "\n There is an issue with the yolov8s_comp68 model file as the expected checksum does not match.\n The model source can be found at: https://github.com/ultralytics/ultralytics/.\n If the model information has changed, please update this script and re-run the tutorial."
       exit 1
   fi
fi
...
-i yolov8s_comp68.onnx \
--output_signaturedefs \
--output_integer_quantized_tflite
   cp saved_model/yolov8s_comp68_full_integer_quant.tflite yolov8s_comp68.tflite
fi
...
if [ -f yolov8s_comp68.tflite ]; then
   tflite_preprocess yolov8s_comp68.tflite  --scale 255
fi
...
if [ -f yolov8s_comp68.pre.tflite ]; then
    echo "Generating VNNX for V1000 comp configuration..."
    vnnx_compile -s V1000 -c comp -t yolov8s_comp68.pre.tflite  -o yolov8s_comp68_V1000_comp.vnnx
fi
...
if [ -f yolov8s_comp68_V1000_comp.vnnx ]; then
    echo "Running Simulation..."
    python $VBX_SDK/example/python/yoloInfer.py yolov8s_comp68_V1000_comp.vnnx $VBX_SDK/tutorials/test_images/dog.jpg -v 8 -l coco.names 
    echo "C Simulation Command:"
    echo '$VBX_SDK/example/sim-c/sim-run-model yolov8s_comp68_V1000_comp.vnnx $VBX_SDK/tutorials/test_images/dog.jpg OBJECT_DETECT'
fi
