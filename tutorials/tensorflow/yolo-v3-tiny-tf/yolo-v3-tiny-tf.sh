...
if [ -f yolo-v3-tiny.h5 ]; then
   if ! echo "ec5699a39a458cbbb6d6a64ff9385ffd yolo-v3-tiny.h5" | md5sum -c; then
       echo -e "\n There is an issue with the yolo-v3-tiny-tf model file as the expected checksum does not match.\n The model source can be found at: https://github.com/openvinotoolkit/open_model_zoo/tree/2021.4.2/models/public/yolo-v3-tiny-tf/.\n If the model information has changed, please update this script and re-run the tutorial."
       exit 1
   fi
fi
