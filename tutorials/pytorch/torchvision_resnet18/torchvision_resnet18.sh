...
if [ -f resnet18.onnx ]; then
   if ! echo "922bc57f3b78add638aade269c97a4ad resnet18.onnx" | md5sum -c; then
       echo -e "\n There is an issue with the torchvision_resnet18 model file as the expected checksum does not match.\n The model source can be found at: https://pytorch.org/vision/0.14/models/generated/torchvision.models.resnet18.html#torchvision.models.resnet18.\n If the model information has changed, please update this script and re-run the tutorial."
       exit 1
   fi
fi
