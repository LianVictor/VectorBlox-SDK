...
if [ -f onnx_resnet18-v1.pre.tflite ]; then
    ...
    vnnx_compile -s V1000 -c ncomp -t onnx_resnet18-v1.pre.tflite  -o onnx_resnet18-v1_V1000_ncomp.vnnx
fi
...
if [ -f onnx_resnet18-v1_V1000_ncomp.vnnx ]; then
    ...
    echo '$VBX_SDK/example/sim-c/sim-run-model onnx_resnet18-v1_V1000_ncomp.vnnx $VBX_SDK/tutorials/test_images/oreo.jpg CLASSIFY'
fi
