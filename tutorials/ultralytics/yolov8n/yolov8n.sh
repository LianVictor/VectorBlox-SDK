...
if [ -f yolov8n_V1000_ncomp.vnnx ]; then
    ...
    echo '$VBX_SDK/example/sim-c/sim-run-model yolov8n_V1000_ncomp.vnnx $VBX_SDK/tutorials/test_images/dog.jpg OBJECT_DETECT'
fi
