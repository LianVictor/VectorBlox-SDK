...
if [ -f yolov8m-cls.pt ]; then
   if ! echo "43788dfadc9c81dc81b2b1f3c03f6428 yolov8m-cls.pt" | md5sum -c; then
       echo -e "\n There is an issue with the yolov8m-cls model file as the expected checksum does not match.\n The model source can be found at: https://github.com/ultralytics/ultralytics/.\n If the model information has changed, please update this script and re-run the tutorial."
       exit 1
   fi
fi
