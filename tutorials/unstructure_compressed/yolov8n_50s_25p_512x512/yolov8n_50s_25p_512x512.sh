...
echo "Checking for yolov8n_50s_25p_512x512 files..."

# model details @ https://github.com/ultralytics/ultralytics/
[ -f coco.names ] || wget -q https://raw.githubusercontent.com/pjreddie/darknet/master/data/coco.names
if [ ! -f yolov8n_50s_25p_512x512.tflite ]; then
   wget -q https://github.com/Microchip-Vectorblox/assets/releases/download/assets/yolov8n_50s_25p_512x512.tflite
fi
...
if [ -f yolov8n_50s_25p_512x512.tflite ]; then
    ...
    vnnx_compile -s V1000 -c ucomp -t yolov8n_50s_25p_512x512.tflite --uint8 -o yolov8n_50s_25p_512x512.ucomp
fi
...
if [ -f yolov8n_50s_25p_512x512.ucomp ]; then
    echo "Running Simulation..."
    python $VBX_SDK/example/python/yoloInfer.py yolov8n_50s_25p_512x512.ucomp $VBX_SDK/tutorials/test_images/dog.jpg -v 8 -l coco.names 
    echo "C Simulation Command:"
    echo '$VBX_SDK/example/sim-c/sim-run-model yolov8n_50s_25p_512x512.ucomp $VBX_SDK/tutorials/test_images/dog.jpg OBJECT_DETECT'
fi
